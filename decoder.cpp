...
void decode8_vector(const std::vector<uint8_t> &src, std::vector<int8_t> &out, int out_chan) {
    ...
    case 1: decode_vector<uint8_t, int8_t, 0>( src, out ); break;
    case 2: decode_vector<uint8_t, int8_t, 0>( src, out ); break;
    case 3: decode_vector<uint8_t, int8_t, 0>( src, out ); break;
